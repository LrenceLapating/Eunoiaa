        ...
        <div class="prompt-content">
          ...
          <div class="assessment-options">
            ...
            <div class="disclaimer-content">
              <strong>Important Notice:</strong> This intervention was generated by AI. Please review and verify it before sending to students.
            </div>
          </div>
        </div>
      </div>
