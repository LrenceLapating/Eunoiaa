...
create index IF not exists idx_assessments_42items_student_completed_risk on public.assessments_42items using btree (student_id, completed_at, risk_level) TABLESPACE pg_default;
...
create index IF not exists idx_assessments_84items_student_completed_risk on public.assessments_84items using btree (student_id, completed_at, risk_level) TABLESPACE pg_default;
...
create index IF not exists idx_ryff_history_student_completion_risk on public.ryff_history using btree (student_id, completion_time, risk_level) TABLESPACE pg_default;
...
create index IF not exists idx_students_gender_status_college on public.students using btree (gender, status, college) TABLESPACE pg_default;

create index IF not exists idx_students_created_status_gender on public.students using btree (created_at, status, gender) TABLESPACE pg_default;
