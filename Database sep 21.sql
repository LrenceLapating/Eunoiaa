...
create index IF not exists idx_college_scores_is_active on public.college_scores using btree (is_active) TABLESPACE pg_default;

create index IF not exists idx_college_scores_active_college_assessment on public.college_scores using btree (
  is_active,
  college_name,
  assessment_type,
  assessment_name
...
create index IF not exists idx_college_scores_active_filters on public.college_scores using btree (
  is_active,
  college_name,
  dimension_name,
  assessment_type
